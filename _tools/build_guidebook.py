...
.gb{max-width:1080px;margin:0 auto;padding:0 var(--gut)}
...
.gb .toc{margin-top:28px;max-width:720px}
...
.gb .taste{margin-top:28px;max-width:760px}
...
def render_index(cat, items):
    ...
    o = [head(title, "index.html", desc, INDEX_CSS, crumbs), NAV, '<main class="page">']
    o.append(f"""<div class="pagehead">
