#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""세트 id 계약(SET_ID_RE) 사본 동기 게이트 (S9-3 1단계 2026-09-11, 미래캠퍼스 6접두 2026-09-14).
...
CONTRACT = r"^(korea_2027_[hs]|korea_gorun_2027_[hs]|yonsei_2027_[hs]|yonsei_intl_2027_i|yonsei_mirae_2027_[jdthgu])(0[1-9]|[12][0-9]|30)$"
