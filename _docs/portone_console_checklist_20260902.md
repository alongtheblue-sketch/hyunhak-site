...
| 23 | 바로오픈 | help open-immediately, cs@portone 09-01 14:52 메일 | MID MOI0126978 발급, 가계약 9/1~9/30, 카드 일시불만. 콘솔 실연동 채널 입력값 = MID + 웹표준결제 SignKey(KG 상점관리자 부가정보). 초기등록비 납부 여부 미확인 | 진행중 | PC-3 집행 (s7, 09-03). 9/30 전 본계약 |
