...
NEW_6_1 = (
    "    <li>실물 상품은 수령 후 7일 이내에 청약철회할 수 있습니다. 다만 소비자에게 책임이 있는 사유로 상품이\n"
    "    멸실되거나 훼손된 경우 등 「전자상거래 등에서의 소비자보호에 관한 법률」 제17조 제2항 각 호의 사유가 있으면\n"
    "    청약철회가 제한될 수 있으며, 내용을 확인하려고 포장을 연 경우는 훼손으로 보지 않습니다(같은 항 제1호 단서).\n"
    "    훼손에 소비자의 책임이 있는지, 계약 체결과 상품 공급의 사실 및 시기에 다툼이 있으면 연구소가 이를\n"
    "    증명합니다(같은 법 제17조 제5항).\n"
    "    단순 변심에 따른 청약철회의 반송 비용은 3,000원이며 구매자가 부담합니다.\n"
    "    상품 하자나 오배송인 경우에는 연구소가 부담합니다.</li>"
)
...
def selftest():
    ...
    for tok in ("제17조 제2항 각 호", "제1호 단서", "제17조 제5항", "생성형 인공지능 도구로 제작하고"):
