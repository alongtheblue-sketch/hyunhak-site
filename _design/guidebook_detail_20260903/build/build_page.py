...
:root{
  ...
  --seal:#BC3529;--brown:#3B2C20;--gold:#D0AC6E;--hair:rgba(49,46,46,.28);--hairs:rgba(49,46,46,.24);
...
.pr p{font-size:var(--t-sm);line-height:1.65}
...
.openers-cap{font-family:var(--mono);font-size:var(--t-xs);color:var(--gray);letter-spacing:.06em;margin-top:var(--s4)}
...
.qs .src{font-family:var(--mono);font-size:12px;color:var(--gray);display:block;margin-top:var(--s1)}
...
.price ul li{font-size:14px;color:var(--body);line-height:1.65;position:relative;padding-left:var(--s3)}
...
.pgv .cap{display:block;font-family:var(--mono);font-size:12px;letter-spacing:.06em;color:var(--gray);margin-bottom:var(--s2);line-height:1.6}
  ...
  <div class="wrap">
    ...
    <ul class="price rv">
      ...
      <li><h4>31개 대학 전권</h4><div class="won two">511,500<small>원, 열람</small></div><div class="won two">1,705,000<small>원, PDF</small></div>
        <ul><li>권당 33,000원 × 31권 = 1,023,000원의 절반</li><li>PDF는 110,000원 × 31권 = 3,410,000원의 절반</li><li>합산 금액은 따로 파는 상품이 아닙니다</li><li>여러 대학에 지원하는 학생, 학교와 학원 단위</li></ul></li>
    </ul>
  </div>
</section>
