...
:root{
  ...
  --seal:#BC3529;--brown:#3B2C20;--gold:#D0AC6E;--hair:rgba(49,46,46,.28);--hairs:rgba(49,46,46,.12);
...
.aud p{font-size:var(--t-sm);line-height:1.65}
...
.rail p{font-size:var(--t-sm);line-height:1.65}
...
.qs .src{font-family:var(--mono);font-size:var(--t-xs);color:var(--gray);display:block;margin-top:var(--s1)}
...
.price ul li{font-size:var(--t-sm);color:var(--body);line-height:1.6;position:relative;padding-left:var(--s3)}
  ...
  <div class="wrap">
    ...
    <ul class="price rv">
      ...
      <li><h4>31개 대학 전권</h4><div class="won two">511,500<small>원, 열람</small></div><div class="won two">1,705,000<small>원, PDF</small></div>
        <ul><li>개별 합산의 절반</li><li>여러 대학에 지원하는 학생, 학교와 학원 단위</li></ul></li>
    </ul>
  </div>
</section>
...
<section class="sec" id="faq">
  <div class="wrap">
    ...
    <div class="faq rv">
      ...
      <details><summary>여러 권을 사면</summary><div class="a">권당 33,000원. 31개 대학 전권 열람은 511,500원으로 개별 합산의 절반. 학교와 학원 단위 좌석은 문의 이메일로.</div></details>
