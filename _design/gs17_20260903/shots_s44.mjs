...
await shot('programs/studio.html', 1440, 900, '.hero', 'st_hero_1440.png');
await shot('programs/studio.html', 1440, 900, '#p1 .head', 'st_p1head_1440.png');
await shot('programs/studio.html', 1440, 900, '#p1', 'st_p1_1440.png');
await shot('programs/studio.html', 1440, 900, '#parts .rail', 'st_rail_1440.png');
await shot('programs/studio.html', 1440, 900, '#units', 'st_units_1440.png');
await shot('programs/guidebook.html', 1440, 900, '#format', 'gb_format_1440.png');
await shot('programs/guidebook.html', 1440, 900, '#trust', 'gb_trust_1440.png');
await shot('programs/guidebook.html', 390, 844, '#books', 'gb_books_390.png');
await shot('programs/guidebook.html', 390, 844, null, 'gb_buybar_390.png', { y: 3000 });
await shot('programs/guidebook.html', 390, 844, '#format', 'gb_format_390.png');
