...
## 4. 법률 에이전트 교차 검토 결과 (legal-contract-privacy-analyst, 07:5x 회신, 1차 출처 재확인)

| 지적 | 처분 |
|---|---|
| 조문 인용 11축(전상법 17조 2항 1호 단서, 3항, 5항, 18조 2항, 12조 1항 단서, 약관규제법 6조 2항 1호, 학원법 2조 1호, 6조 1항, 22조 1항 1호, 령 2조 2항, 평생교육법 33조 2항, 표시광고법 5조, 부경법 파목, 콘텐츠법 37조 1항) 일치 | 유지 |
| 6조 1항 초안 "제1호 사유에만 제한" = 17조 2항 2~4호를 스스로 포기하는 문면 | 각 호 유지 + 1호 단서 명시로 재작성(패처 NEW_6_1, 초안, 공지, 의뢰서, verify 토큰). faq 본문과 JSON-LD 2곳도 같은 문안이라 정렬(s44 GS-16 ① 문안의 같은 결함) |
| 17조 5항을 "훼손 책임" 으로 축소 인용 | 계약 체결과 공급의 사실 및 시기까지 확장 |
| 학원법 2조 1호 "교습과정 반복 30일 포함" 괄호 누락 | 의뢰서 2부 §2 추가(시청 3개월, 순차 공개 판단 직결) |
| 콘텐츠법 37조 1항 3요소는 시행령 소관인데 법률 문언처럼 읽힘 | 문면 정정 + 4부 시행령 병기 |
| 평생교육법 33조 항 미특정, 조 제목 원격대학형태 평생교육시설 | 33조 2항 원격 평생교육시설 신고로 특정(의뢰서, 질의서) |
| 질의서 "교습 과정 편성, 수강 대상, 동시 수강 인원 제한 없음" = 쟁점어 자인 + 령 2조 2항 10명 초과 자인 | 강의 편성, 이용 대상, 이용 규모 [확인] 3자리로 재서술 |
| 질의서 첨부 ② 8조의2 는 열람 서비스 조항 | 이용약관 전문으로 |
| "통신판매업 신고 면제" 시행령 기준 실측 없는 단정 | "표기 중, 시행령 기준 확인 요청" + 의뢰서 §4(a) 확인 항목 |
| 수신 부서 = 평생교육건강과(2025 학원 업무 편람 게시 부서), 원격 관할 지원청/본청 미검증 | 질의서 수신란 기입 + [확인] 유지 |
| 빠진 쟁점 3 = 17조 6항 표시 의무(08-30 의뢰서 §4-1), 17조 2항 5호 단서 가분 미개시분(약관 6조 미명시, faq 만 명시), 학원법 반복 괄호 | 의뢰서 §4(a) 항목 추가 |
| 4부 목록의 5호 인용이 본문 논증 0 | 5호 단서 질의 추가로 해소 |

교차 검토 뒤 재빌드, 문체 게이트 재스캔(등급 A 유지), 후속 커밋. 곁다리 자동 치환 결함 = 가운뎃점을 와/과로 바꾸는 정규식이 3항목 나열("지식·기술·예능")에서 "지식, 기술과 예능" 을 만들었다. 3곳 손으로 정정.
