// 배포 2차 라이브 실측 (s8, 2026-09-23). https://hyunhak.com 실브라우저(system Chrome, 프록시 환경 그대로).
...
const popupState = () => {
  ...
  return { open: !!document.querySelector(".pdim"), cards: slots.length, btn: btn && { text: btn.textContent.trim(), pressed: btn.getAttribute("aria-pressed") }, cur: document.querySelector("[data-ppop-cur]")?.textContent, slots };
};
