// 배포 2차 라이브 실측 (s8, 2026-09-23, r5 판: 하단바 ←/→ 넘김 추가). https://hyunhak.com 실브라우저(system Chrome, 프록시 환경 그대로).
