...
| 17:52 | deploy 4차 | 승계 세션 | main ff e22841e → _tools/deploy.sh(우회 변수 없음) | [0] origin/main 8a79fc9, 라이브 96be167 모두 조상 OK → 자산 3파일 업로드 → [post] 라이브 _gen e22841e 일치 → 엣지 스모크 FAIL 0 / WARN 0 / 28 → indexnow 200(110) → push 8a79fc9..e22841e. 17:52:53 종료 |
| 17:5x | live 실측 | 승계 세션 | r6/live_check.json, r7/live/keys_pause_check_live.json, r7/live/keys_endhome_check_live.json, studio_units_20260923/live_check_deploy4_20260923.json | r6: 1440/390 첫 초점 pdim, → 위치 넘김 전후 동일, barTop = popBottom - 1(643.1/644.1, 621.4/622.4), 모션 감소 「재생」 cur 불변, 목록 열 1/1/2/2/3, 가로 넘침 0, 가입 5행 같은 줄. keys_pause 3/3, End/Home 4/4. 스튜디오 gen e22841e option 12 카드 12 sku 12/12 errors 0. 자산 sha 로컬 = 라이브(app.js 15e5a111, base.css 97e550d7, index.html 31a373e8) |
